...
AS $$
DECLARE
  project_url TEXT := 'https://roganthdeeaqwadumwxm.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJvZ2FudGhkZWVhcXdhZHVtd3htIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzk3NTIwOCwiZXhwIjoyMDIzNTUxMjA4fQ.hzhs_xeeoIquIfHH4ddwu5aP-wxglGQLwHxpTpDgU8A'; -- full access needed for http request to storage
